...
<html lang="pt">
    <head>
        <meta charset="utf-8" />
        <title>Deriva - Busca de Navegantes</title>
    ...
    <body>
        ...
        <div id="content">
                <section class="hfeed">
                                    <h2>Navegantes encontrados</h2>
                                    <p>
                                         <c:if test="${requestScope.hasPrevious == true}">
                                               <a href="/Busca?pagina=${requestScope.numeroPagina - 1}"><h4>< anterior</h4></a>
                                           </c:if>
                                           <c:if test="${requestScope.hasNext == true}">
                                               <a href="/Busca?pagina=${requestScope.numeroPagina + 1}"><h4> proxima > </h4></a>
                                           </c:if>
                                    </p>
